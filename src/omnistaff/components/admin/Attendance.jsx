                  ...
                  <tbody>
                    {logs.map((log, index) => (
                      <tr key={log.id || index}>
                        ...
                        <td className="number-font" style={{ fontSize: '0.8rem', color: 'var(--color-success)' }}>{log.checkIn || log.punchIn || '--:--:--'}</td>
                        <td className="number-font" style={{ fontSize: '0.8rem', color: 'var(--color-danger)' }}>{log.checkOut || log.punchOut || '--:--:--'}</td>
