...
import { 
  ...
  FileText, Calendar, ShieldCheck, Menu, Briefcase
} from 'lucide-react';
              ...
              >
                ...
                {onLogout && (
                  <button 
                    ...
                    style={{ display: 'flex', alignItems: 'center', gap: 10, padding: 10, border: 'none', background: 'rgba(239, 68, 68, 0.08)', width: '100%', textAlign: 'left', borderRadius: 8, cursor: 'pointer', fontSize: '0.85rem', color: '#ef4444', fontWeight: 600, marginTop: 4 }}
                  >
                    Logout Workspace
                  </button>
                )}
